package puj.patterns.mundo;

import puj.patterns.mundo.Armas.Arma;
import puj.patterns.mundo.Armas.Cuchillo;
import puj.patterns.mundo.Exceptions.DatosErroneosException;
import puj.patterns.mundo.Exceptions.NombreInvalidoException;
import puj.patterns.mundo.Factory.AbstractFactory;
import puj.patterns.mundo.Factory.FactoryProvider;
import puj.patterns.mundo.Memento.MementoCareTaker;
import puj.patterns.mundo.Pantalla.ExtendedScreen;
import puj.patterns.mundo.Pantalla.NormalScreen;
import puj.patterns.mundo.Pantalla.ScreenSizeContext;
import puj.patterns.mundo.Personajes.*;
import puj.patterns.mundo.GameDataLogs.ComparadorPuntajePorNombre;
import puj.patterns.mundo.GameDataLogs.EventManager;
import puj.patterns.mundo.GameDataLogs.Puntaje;
...
public class SurvivorCamp implements Cloneable, Comparator<Puntaje> {
	...
	public Boss generarBoss() {
		jefe = (puj.patterns.mundo.Personajes.Boss) BossFactory.getBoss("Boss",(byte) 0);
		return jefe;
	}
	...
	/**
	 * carga la �ltima partida guardada usanado el patr�n Memento
	 * devuelve la partida clonada porque la actual pasa a estar sin juego
	 * y as� elimina los hilos en ejecuci�n
	 * 
	...
	private void cargaBossSiExiste(int ronda, byte salud) {
		if (ronda == 10) {
			jefe = (puj.patterns.mundo.Personajes.Boss) BossFactory.getBoss("BossFactory",salud);
			zombNodoCercano.setAtras(zombNodoLejano);
			zombNodoLejano.setAlFrente(zombNodoCercano);
		}
	}
	...
	/**
	 * guarda la partida actual usando el patr�n Memento
	 * 
	 * @throws IOException
